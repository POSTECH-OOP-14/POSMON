...
public class ChangeCharacter : MonoBehaviour {
    ...
    void OnGUI()
    {
        OpponentStudentImage = new Rect(cam.pixelWidth * 3 / 4, cam.pixelHeight * 1 / 4, cam.pixelWidth / 8, cam.pixelWidth / 8);
      OurStudentImage = new Rect(cam.pixelWidth * 1 / 4, cam.pixelHeight * 3 / 4, cam.pixelWidth / 8, cam.pixelWidth / 8);
